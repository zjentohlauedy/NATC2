...
class PlayerRetirementProxyTest {
    ...
    class ReadyToRetire {
        ...
        void shouldReturnFalseIfPlayerAgeIsUnderTwentyOneAndHasMinimumVitalityWithMaxRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(18).vitality(0.0).build()));
            assertFalse(proxy.readyToRetire(Player.builder().age(19).vitality(0.0).build()));
            assertFalse(proxy.readyToRetire(Player.builder().age(20).vitality(0.0).build()));
        }
        ...
        void shouldReturnTrueIfPlayerIsTwentyOneAndHasMinimumVitalityWithMaxRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(21).vitality(0.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerIsTwentyOneAndHasMinimumVitalityWithNearMaxRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(21).vitality(0.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerIsFortyAndHasMinimumVitalityWithMinRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(40).vitality(0.0).build()));
        }
        ...
        void shouldReturnTrueIfPlayerIsFortyAndHasMinimumVitalityWithNearMinRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(40).vitality(0.0).build()));
        }
        ...
        void shouldReturnTrueIfPlayerAgeIsOverFortyAndHasMinimumVitalityWithMinRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(41).vitality(0.0).build()));
            assertTrue(proxy.readyToRetire(Player.builder().age(42).vitality(0.0).build()));
            assertTrue(proxy.readyToRetire(Player.builder().age(43).vitality(0.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerAgeIsUnderThirtySixAndHasMaximumVitalityWithMaxRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(33).vitality(1.0).build()));
            assertFalse(proxy.readyToRetire(Player.builder().age(34).vitality(1.0).build()));
        ...
        void shouldReturnTrueIfPlayerIsThirtySixAndHasMaximumVitalityWithMaxRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(36).vitality(1.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerIsThirtySixAndHasMaximumVitalityWithNearMaxRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(36).vitality(1.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerIsFortyFiveAndHasMaximumVitalityWithMinRandomReturned() {
            ...
            assertFalse(proxy.readyToRetire(Player.builder().age(45).vitality(1.0).build()));
        }
        ...
        void shouldReturnTrueIfPlayerIsFortyFiveAndHasMaximumVitalityWithNearMinRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(45).vitality(1.0).build()));
        }
        ...
        void shouldReturnTrueIfPlayerAgeIsOverFortyFiveAndHasMaximumVitalityWithMinRandomReturned() {
            ...
            assertTrue(proxy.readyToRetire(Player.builder().age(46).vitality(1.0).build()));
            assertTrue(proxy.readyToRetire(Player.builder().age(47).vitality(1.0).build()));
            assertTrue(proxy.readyToRetire(Player.builder().age(48).vitality(1.0).build()));
        }
    ...
    class ShouldRetire {
        ...
        void shouldReturnFalseIfPlayerAgeIsUnderTwentyOneAndHasMinimumVitality() {
            assertFalse(proxy.shouldRetire(Player.builder().age(18).vitality(0.0).build()));
            assertFalse(proxy.shouldRetire(Player.builder().age(19).vitality(0.0).build()));
            assertFalse(proxy.shouldRetire(Player.builder().age(20).vitality(0.0).build()));
        }

        @Test
        void shouldReturnTrueIfPlayerAgeIsOverTwentyAndHasMinimumVitality() {
            assertTrue(proxy.shouldRetire(Player.builder().age(21).vitality(0.0).build()));
            assertTrue(proxy.shouldRetire(Player.builder().age(22).vitality(0.0).build()));
            assertTrue(proxy.shouldRetire(Player.builder().age(23).vitality(0.0).build()));
        }
        ...
        void shouldReturnFalseIfPlayerAgeIsUnderThirtySixAndHasMaximumVitality() {
            assertFalse(proxy.shouldRetire(Player.builder().age(33).vitality(1.0).build()));
            assertFalse(proxy.shouldRetire(Player.builder().age(34).vitality(1.0).build()));
            assertFalse(proxy.shouldRetire(Player.builder().age(35).vitality(1.0).build()));
        }

        @Test
        void shouldReturnTrueIfPlayerAgeIsOverThirtyFiveAndHasMaximumVitality() {
            assertTrue(proxy.shouldRetire(Player.builder().age(36).vitality(1.0).build()));
            assertTrue(proxy.shouldRetire(Player.builder().age(37).vitality(1.0).build()));
            assertTrue(proxy.shouldRetire(Player.builder().age(38).vitality(1.0).build()));
        }
    }
}